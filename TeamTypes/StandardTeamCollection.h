#ifndef STANDARDTEAMCOLLECTION_H
#define STANDARDTEAMCOLLECTION_H

#include "StandardTeam.h"
#include <vector>
#include <iostream>

class StandardTeamCollection  {
    public:
    std::vector<StandardTeam> teams;
    private:
    int maxSize;
    double prevMin;

    public:
    StandardTeamCollection(int n) {
        maxSize = n;
        prevMin = 1000;
    }
